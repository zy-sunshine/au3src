...
AUT_RESULT ModuleFile::F_IniWrite(VectorVariant &vParams, Variant &vResult)
{
    char    szFileTemp[_MAX_PATH+1];
...
AUT_RESULT ModuleFile::F_IniDelete(VectorVariant &vParams, Variant &vResult)
{
    char    szFileTemp[_MAX_PATH+1];
...
//////////////////////////////////////////////////////////////////////////
AUT_RESULT ModuleFile::F_IniReadSection(VectorVariant &vParams, Variant &vResult)
{
...
AUT_RESULT ModuleFile::F_IniReadSectionNames(VectorVariant &vParams, Variant &vResult)
{
    // Store start/end positions to speed up processing
    struct Section
    {
...
AUT_RESULT ModuleFile::F_FileOpen(VectorVariant &vParams, Variant &vResult)
{
...
AUT_RESULT ModuleFile::F_FileClose(VectorVariant &vParams, Variant &vResult)
{
...
AUT_RESULT ModuleFile::F_FileReadLine(VectorVariant &vParams, Variant &vResult)
{
...
AUT_RESULT ModuleFile::F_FileRead(VectorVariant &vParams, Variant &vResult)
{
    size_t    Len;
    FILE    *fptr;
...
AUT_RESULT ModuleFile::F_FileWriteLine(VectorVariant &vParams, Variant &vResult)
{
...
AUT_RESULT ModuleFile::F_FileWrite(VectorVariant &vParams, Variant &vResult)
{
...
AUT_RESULT ModuleFile::FileWriteLine(VectorVariant &vParams, Variant &vResult, bool bWriteLine)
{
...
AUT_RESULT ModuleFile::F_FileGetTime(VectorVariant &vParams, Variant &vResult)
{
    SYSTEMTIME        st;
    HANDLE            fileIn;
...
AUT_RESULT ModuleFile::F_FileSetTime (VectorVariant &vParams, Variant &vResult)
{
    SYSTEMTIME    st;
    FILETIME    ft;
...
bool ModuleFile::FileSetTime_recurse (const char *szIn, FILETIME *ft, int nWhichTime, bool bRecurse)
{
    WIN32_FIND_DATA    findData;
...
AUT_RESULT ModuleFile::F_FileGetSize(VectorVariant &vParams, Variant &vResult)
{
...
AUT_RESULT ModuleFile::F_FileOpenDialog(VectorVariant &vParams, Variant &vResult)
{
...
AUT_RESULT ModuleFile::F_FileSaveDialog(VectorVariant &vParams, Variant &vResult)
{
...
AUT_RESULT ModuleFile::FileDialog(VectorVariant &vParams, Variant &vResult, uint iNumParams, int nFlag)
{
    OPENFILENAME    ofn;
...
AUT_RESULT ModuleFile::F_FileSelectFolder (VectorVariant &vParams, Variant &vResult)
{
...
int CALLBACK ModuleFile::BrowseForFolderProc(HWND hWnd,UINT iMsg,LPARAM lParam,LPARAM lpData)
{
    switch(iMsg)
    {
...
AUT_RESULT ModuleFile::F_DriveMapAdd(VectorVariant &vParams, Variant &vResult)
{
    NETRESOURCE    nr;
    DWORD        res;
    uint        iNumParams = vParams.size();
...
AUT_RESULT ModuleFile::F_DriveMapDel(VectorVariant &vParams, Variant &vResult)
{
...
AUT_RESULT ModuleFile::F_DriveMapGet(VectorVariant &vParams, Variant &vResult)
{
    char    szBuffer[1024];
    DWORD    dwLen = 1024;
...
AUT_RESULT ModuleFile::F_DriveGetDrive(VectorVariant &vParams, Variant &vResult)
{
    char    szVat[27][4];
    AString    sBuffer;
    int     n = 0, nFound = 0;
...
AUT_RESULT ModuleFile::F_CDTray(VectorVariant &vParams, Variant &vResult)
{
...
AUT_RESULT ModuleFile::F_DriveGetType(VectorVariant &vParams, Variant &vResult)
{
...
AUT_RESULT ModuleFile::F_DriveSpaceTotal(VectorVariant &vParams, Variant &vResult)
{
    SetErrorMode(SEM_FAILCRITICALERRORS);        // So a:\ does not ask for disk
...
AUT_RESULT ModuleFile::F_DriveSpaceFree(VectorVariant &vParams, Variant &vResult)
{
    SetErrorMode(SEM_FAILCRITICALERRORS);        // So a:\ does not ask for disk
...
AUT_RESULT ModuleFile::F_DriveStatus(VectorVariant &vParams, Variant &vResult)
{
    SetErrorMode(SEM_FAILCRITICALERRORS);        // So a:\ does not ask for disk
...
AUT_RESULT ModuleFile::F_DriveGetFileSystem(VectorVariant &vParams, Variant &vResult)
{
    char            szBuffer[256];
...
AUT_RESULT ModuleFile::F_DriveGetSerial(VectorVariant &vParams, Variant &vResult)
{
    char            szBuffer[256];
    char            szFileSystem[256];
    DWORD            dwVolumeSerial,dwMaxCL,dwFSFlags;
...
AUT_RESULT ModuleFile::F_DriveGetLabel(VectorVariant &vParams, Variant &vResult)
{
    char            szBuffer[256];
    char            szFileSystem[256];
    DWORD            dwVolumeSerial,dwMaxCL,dwFSFlags;
...
AUT_RESULT ModuleFile::F_DriveSetLabel(VectorVariant &vParams, Variant &vResult)
{
    AString sTemp = vParams[0].szValue();
    if ( sTemp[sTemp.length()-1] != '\\' )    // Attemp to fix the parameter passed
        sTemp += "\\";
...
AUT_RESULT ModuleFile::F_FileCreateShortcut(VectorVariant &vParams, Variant &vResult)
{
    uint            iNumParams = vParams.size();
...
AUT_RESULT ModuleFile::F_FileGetShortcut(VectorVariant &vParams, Variant &vResult)
{
    IShellLink        *psl;
    IPersistFile    *ppf;
    WORD            wsz[MAX_PATH+1];
...
AUT_RESULT ModuleFile::F_FileInstall(VectorVariant &vParams, Variant &vResult)
{
    bool            bOverwrite;
    bool            bDestExists;
...
AUT_RESULT ModuleFile::F_FileRecycle(VectorVariant &vParams, Variant &vResult)
{
...
AUT_RESULT ModuleFile::F_FileRecycleEmpty(VectorVariant &vParams, Variant &vResult)
{
...
AUT_RESULT ModuleFile::F_FileGetAttrib (VectorVariant &vParams, Variant &vResult)
{
    DWORD        dwTemp;
    AString        aRet;
...
AUT_RESULT ModuleFile::F_FileSetAttrib (VectorVariant &vParams, Variant &vResult)
{
    DWORD        dwTemp;
    DWORD        dwAdd = 0;
    DWORD        dwRemove = 0;
...
bool ModuleFile::FileSetAttrib_recurse (const char *szIn, DWORD dwAdd, DWORD dwRemove, bool bRecurse)
{
    WIN32_FIND_DATA    findData;
    DWORD            dwTemp;
...
AUT_RESULT    ModuleFile::F_FileFindFirstFile(VectorVariant &vParams, Variant &vResult)
{
    WIN32_FIND_DATA        wfd;
    int                    nFreeHandle;
...
AUT_RESULT    ModuleFile::F_FileFindNextFile(VectorVariant &vParams, Variant &vResult)
{
    WIN32_FIND_DATA        wfd;
    int                    nHandle = vParams[0].nValue();
...
AUT_RESULT ModuleFile::F_FileGetLongName(VectorVariant &vParams, Variant &vResult)
{
...
AUT_RESULT ModuleFile::F_FileGetShortName(VectorVariant &vParams, Variant &vResult)
{
...
AUT_RESULT ModuleFile::F_DirCopy(VectorVariant &vParams, Variant &vResult)
{
    bool    bTemp = false;
...
AUT_RESULT ModuleFile::F_DirRemove(VectorVariant &vParams, Variant &vResult)
{
    bool    bTemp = false;
...
AUT_RESULT ModuleFile::F_FileCopy(VectorVariant &vParams, Variant &vResult)
{
    bool bTemp = false;
...
AUT_RESULT ModuleFile::F_FileMove(VectorVariant &vParams, Variant &vResult)
{
    bool    bTemp = false;
...
AUT_RESULT ModuleFile::F_FileChangeDir(VectorVariant &vParams, Variant &vResult)
{
...
AUT_RESULT ModuleFile::F_DirMove(VectorVariant &vParams, Variant &vResult)
{
    bool bTemp = false;
...
AUT_RESULT ModuleFile::F_DirGetSize(VectorVariant &vParams, Variant &vResult)
{
    uint    iNumParams    = vParams.size();
...
bool ModuleFile::GetDirSize(const char *szInputPath, __int64 &nSize, __int64 &nFiles, __int64 &nDirs,  bool bExt, bool bRec)
{
