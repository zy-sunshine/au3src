...
void ModuleReg::RegSplitKey(AString sFull, AString &sCname, AString &sKey, AString &sSubKey)
{
    int nPos;
...
bool ModuleReg::RegGetMainKey(AString sKey, HKEY &hKey)
{
    sKey.toupper();
...
AUT_RESULT ModuleReg::F_RegRead(VectorVariant &vParams, Variant &vResult)
{
...
AUT_RESULT ModuleReg::F_RegWrite(VectorVariant &vParams, Variant &vResult)
{
...
AUT_RESULT ModuleReg::F_RegDelete(VectorVariant &vParams, Variant &vResult)
{
...
AUT_RESULT ModuleReg::F_RegEnumKey(VectorVariant &vParams, Variant &vResult)
{
...
AUT_RESULT ModuleReg::F_RegEnumVal(VectorVariant &vParams, Variant &vResult)
{
    // $var = RegEnumKey(key, instance)
